...
<body>
  ...
  <div class="container1">
    ...
    <h3 class="subtitle" style="font-size: 20px;">Create and Start your AI Mock Interview</h3>
    ...
    <h2 class="section-title" style="font-size: 20px;">Previous Mock Interviews</h2>
